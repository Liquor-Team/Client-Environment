            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: GradientText(
                    /// '${cocktail_info[cocktaildata.id].name}',        TODO : 칵테일 이름
                    widget.name,
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontFamily: 'kor',
                ...
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Text(widget.recipe),///recipe_Data[cocktaildata.id],                        ///TODO : 칵테일 레시피
                  ),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  ...
                  child: SingleChildScrollView(
                    scrollDirection: Axis.vertical,
                    child: Text(widget.description) ///cocktail_summary_data[cocktaildata.id],            /// TODO : 칵테일 설명
                  ),
                ),
              ],
            ),
