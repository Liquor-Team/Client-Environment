                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () async {
                      try {
                        ...
                        ///  사진이 찍히는 부분
                        var imageFormData = await _createImageToHttpForm(
                            key: "file", image: image);

                        /// 사진을 Http Form 데이터 형식으로 변환.
                        ...
                        progressDialog.show(
                            ...
                            msg: '',
                            completed: Completed(
                                completedMsg: '찾았다!', closedDelay: 2000));
                         */
                        ...
                        /// 결과를 Map에 담고(type casting)
                        final parsedYoloResponse =
                            CameraResponse.fromJson(responseMap);

                        /// Map을 OneResponse로 바꿈
                        print("Tlqkf-after");
