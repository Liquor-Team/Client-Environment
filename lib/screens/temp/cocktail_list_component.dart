...
import 'package:simple_gradient_text/simple_gradient_text.dart';
import 'package:graduation_project/screens/temp/cocktail_informtaion.dart';
import 'package:http/http.dart' as http;
import '../../models/cocktail_list_by_liquor.dart';
import '../../models/cocktail_list_model.dart';

class CocktailListComponent extends StatefulWidget {

  String liquorName;
  String liquorImgUrl;
  CocktailListComponent({Key? key, required this.liquorName, required this.liquorImgUrl}) : super(key: key);

  @override
  State<CocktailListComponent> createState() => _CocktailListComponentState();
}

class _CocktailListComponentState extends State<CocktailListComponent> {
