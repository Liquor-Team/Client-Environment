...
import '../../screens/information_result/temp_information.dart';
  ...
  Future<void> initState() async {
    ...
    if(parsedYoloResponse.size! > 1) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => TempInformation(liquorName: "Jim-Beam"))
      );

    } else if (parsedYoloResponse.size! == 1) {   /// 1개
      Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => TempInformation(
