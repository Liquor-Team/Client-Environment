...
class JimBeamCocktailData extends StatefulWidget {
  const JimBeamCocktailData({Key? key, required this.cocktail}) : super(key: key);

  final Cocktail cocktail;

  @override
  State<JimBeamCocktailData> createState() => _JimBeamCocktailDataState(cocktail);
}
...
class _JimBeamCocktailDataState extends State<JimBeamCocktailData> {
  ...
  List<Column> jimbeamm_cocktail_recipe = List.from(jimbeam_cocktail_recipe);
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: GradientText(
                    '${jimbeam_cocktail_info[jimbeamcocktaildata.id].name}',
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontFamily: 'kor',
                      fontSize: 60,
                ...
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: jimbeamm_cocktail_recipe[jimbeamcocktaildata.id],
                  ),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  ...
                  child: SingleChildScrollView(
                    scrollDirection: Axis.vertical,
                    child: jimbeam_cocktail_summary_data[jimbeamcocktaildata.id]
                  ),
                ),
              ],
            ),
