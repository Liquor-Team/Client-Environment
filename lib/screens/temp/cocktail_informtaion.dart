...
class CocktailInformation extends StatefulWidget {
  String name;
  String imgUrl;
  String recipe;
  String description;
  ...
  @override
  State<CocktailInformation> createState() => _CocktailInformationState();
}

class _CocktailInformationState extends State<CocktailInformation> {
