...
class DeprecatedInformation extends StatefulWidget {
  final String liquorName;                        /// 정보를 나타낼 술의 이름 (영어)

  const DeprecatedInformation({
    Key? key,
    required this.liquorName,
  }) : super(key: key);
  
  @override
  State<DeprecatedInformation> createState() => _DeprecatedInformationState();
}

class _DeprecatedInformationState extends State<DeprecatedInformation> {
